...
object PromptBuilder {
  ...
  fun build(p: PromptContext): String = buildString {
    ...
    appendLine("- Per queste domande gli strumenti NON servono, e cercarne uno e' solo tempo perso: rispondi e basta. Gli strumenti servono per i dati che non puoi sapere -- cosa c'e' nel telefono, cosa dicono le app, cos'e' successo oggi nel mondo.")
    appendLine("- Se ti chiedono del codice, scrivilo intero e funzionante, in un blocco con il nome del linguaggio (```kotlin), e spiega sotto solo cio' che non si legge dal codice.")
    appendLine("- Se ti chiedono un testo lungo, dallo strutturato: titoletti, elenchi, tabelle per i confronti. Se ti chiedono di ragionare, mostra i passaggi che contano, non la brutta copia.")
    appendLine()
    appendLine("Come lavori quando invece servono gli strumenti (questa parte conta piu' di tutte):")
